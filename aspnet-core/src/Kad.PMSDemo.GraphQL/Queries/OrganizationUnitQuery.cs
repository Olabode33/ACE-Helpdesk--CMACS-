...
using Kad.PMSDemo.Core.Base;
using Kad.PMSDemo.Core.Extensions;
using Kad.PMSDemo.Dto;
using Kad.PMSDemo.Types;

namespace Kad.PMSDemo.Queries
{
    public class OrganizationUnitQuery : PMSDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
