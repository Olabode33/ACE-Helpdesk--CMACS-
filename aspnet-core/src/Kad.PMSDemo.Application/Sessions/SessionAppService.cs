...
{
    public class SessionAppService : PMSDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = PMSDemoConsts.Currency,
                    CurrencySign = PMSDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = PMSDemoConsts.AllowTenantsToChangeEmailSettings,
