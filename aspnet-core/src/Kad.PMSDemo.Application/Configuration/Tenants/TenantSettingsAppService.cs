...
using Kad.PMSDemo.Configuration.Tenants.Dto;
using Kad.PMSDemo.Security;
using Kad.PMSDemo.Storage;
using Kad.PMSDemo.Timing;

namespace Kad.PMSDemo.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !PMSDemoConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
