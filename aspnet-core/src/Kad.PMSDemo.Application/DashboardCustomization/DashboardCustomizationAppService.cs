...
using Kad.PMSDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Kad.PMSDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PMSDemoAppServiceBase, IDashboardCustomizationAppService
    {
