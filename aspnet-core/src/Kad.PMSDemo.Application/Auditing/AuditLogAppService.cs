...
using Kad.PMSDemo.Auditing.Exporting;
using Kad.PMSDemo.Authorization;
using Kad.PMSDemo.Authorization.Users;
using Kad.PMSDemo.Dto;
using Kad.PMSDemo.EntityHistory;
using EntityHistoryHelper = Kad.PMSDemo.EntityHistory.EntityHistoryHelper;

namespace Kad.PMSDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PMSDemoAppServiceBase, IAuditLogAppService
    {
