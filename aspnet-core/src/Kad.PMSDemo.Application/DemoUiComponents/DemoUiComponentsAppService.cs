...
using Kad.PMSDemo.DemoUiComponents.Dto;

namespace Kad.PMSDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PMSDemoAppServiceBase, IDemoUiComponentsAppService
    {
