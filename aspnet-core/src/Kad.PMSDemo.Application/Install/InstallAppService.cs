...
using Kad.PMSDemo.Migrations.Seed;
using Kad.PMSDemo.Migrations.Seed.Host;
...
namespace Kad.PMSDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PMSDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PMSDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{PMSDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{PMSDemoConsts.ConnectionStringName}", constring);
        }
