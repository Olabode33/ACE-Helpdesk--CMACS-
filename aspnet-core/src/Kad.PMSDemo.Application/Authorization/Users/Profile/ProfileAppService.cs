...
using Kad.PMSDemo.Authentication.TwoFactor.Google;
using Kad.PMSDemo.Authorization.Users.Dto;
using Kad.PMSDemo.Authorization.Users.Profile.Cache;
using Kad.PMSDemo.Authorization.Users.Profile.Dto;
using Kad.PMSDemo.Configuration;
using Kad.PMSDemo.Friendships;
using Kad.PMSDemo.Gdpr;
using Kad.PMSDemo.Net.Sms;
using Kad.PMSDemo.Security;
using Kad.PMSDemo.Storage;
using Kad.PMSDemo.Timing;

namespace Kad.PMSDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PMSDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Kad.PMSDemo",
