...
using Kad.PMSDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace Kad.PMSDemo.Web.Startup
{
    ...
    public class PMSDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PMSDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PMSDemoWebHostModule).GetAssembly());
        }
