...
using Kad.PMSDemo.Web.Models.TokenAuth;
using Kad.PMSDemo.Authorization.Impersonation;
...
using Kad.PMSDemo.Web.Authentication.External;
...
namespace Kad.PMSDemo.Web.Controllers
{
    ...
    public class TokenAuthController : PMSDemoControllerBase
    {
