...
using Kad.PMSDemo.Services.Navigation;
...
using Kad.PMSDemo.Controls;
using Kad.PMSDemo.Dto;
using Kad.PMSDemo.Extensions;
using Kad.PMSDemo.Localization;
using Kad.PMSDemo.UI;
using Kad.PMSDemo.UI.Assets;
using Kad.PMSDemo.Views;
using DependencyResolver = Kad.PMSDemo.Core.Dependency.DependencyResolver;
...
namespace Kad.PMSDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PMSDemo";
