...
using Kad.PMSDemo.Authorization.Ldap;
...
using Kad.PMSDemo.DashboardCustomization.Definitions;
using Kad.PMSDemo.Debugging;
using Kad.PMSDemo.DynamicEntityProperties;
using Kad.PMSDemo.Features;
...
using Kad.PMSDemo.WebHooks;

namespace Kad.PMSDemo
{
    [DependsOn(
        typeof(PMSDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class PMSDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            PMSDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = PMSDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, PMSDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<PMSDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PMSDemoCoreModule).GetAssembly());
        }
