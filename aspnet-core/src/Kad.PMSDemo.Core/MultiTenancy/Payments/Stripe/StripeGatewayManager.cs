...
{
    public class StripeGatewayManager : PMSDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "PMSDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PMSDemoConsts.Currency;
        }
