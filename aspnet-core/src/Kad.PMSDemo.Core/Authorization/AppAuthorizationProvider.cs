...
namespace Kad.PMSDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            //Additional buttons
            requests.CreateChildPermission(AppPermissions.Pages_Requests_AssignRequest, L("AssignRequest"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_TreatRequest, L("TreatRequest"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_CreateTOR, L("CreateTOR"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_ApproveTOR, L("ApproveTOR"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_GetApproval, L("GetApproval"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_ApproveRequest, L("ApproveRequest"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_MarkAsCompleted, L("MarkAsCompleted"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_CmacsManager, L("CmacsManagerApproval"));
            //Role Specific
            requests.CreateChildPermission(AppPermissions.Pages_Requests_TechnicalTeam, L("TechTeam"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_RequestingTeam, L("RequestingTeam"));
            requests.CreateChildPermission(AppPermissions.Pages_Requests_Configuration, L("Configutation"));
        ...
        {
            return new LocalizableString(name, PMSDemoConsts.LocalizationSourceName);
        }
    }
}
