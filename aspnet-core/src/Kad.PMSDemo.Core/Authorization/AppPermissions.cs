namespace Kad.PMSDemo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Requests_RequestingTeam = "Pages.Requests.RequestingTeam";
        ...
        //Added to cater for additional functionalities on the request page
        public const string Pages_Requests_AssignRequest = "Pages.Requests.Assign";
        public const string Pages_Requests_TreatRequest = "Pages.Requests.Treat";
        public const string Pages_Requests_TechnicalTeam = "Pages.Requests.TechTeams";
        public const string Pages_Requests_CreateTOR = "Pages.Requests.CreateTOR";
        public const string Pages_Requests_ApproveTOR = "Pages.Requests.ApproveTOR";
        public const string Pages_Requests_GetApproval = "Pages.Requests.GetApproval";
        public const string Pages_Requests_ApproveRequest = "Pages.Requests.ApproveRequest";
        public const string Pages_Requests_CmacsManager = "Pages.Requests.CmacsManagerApprover";
        public const string Pages_Requests_MarkAsCompleted = "Pages.Requests.MarkAsCompleted";
        public const string Pages_Requests_Configuration = "Pages.Requests.Configuration";
