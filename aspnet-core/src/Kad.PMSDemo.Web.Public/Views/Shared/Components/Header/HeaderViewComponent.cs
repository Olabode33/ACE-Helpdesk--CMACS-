...
using Kad.PMSDemo.Web.Public.Startup;
using Kad.PMSDemo.Web.Session;

namespace Kad.PMSDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PMSDemoViewComponent
    {
