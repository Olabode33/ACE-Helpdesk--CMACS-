...
namespace Kad.PMSDemo.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PMSDemoConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(PMSDemoDbContext context)
        {
            _context = context;
        }
