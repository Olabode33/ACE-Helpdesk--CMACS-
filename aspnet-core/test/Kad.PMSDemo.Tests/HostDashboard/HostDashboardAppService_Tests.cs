...
using Kad.PMSDemo.MultiTenancy.HostDashboard;
...
namespace Kad.PMSDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PMSDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
