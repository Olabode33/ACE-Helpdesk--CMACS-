...
using Kad.PMSDemo.Test.Base.DependencyInjection;
using Kad.PMSDemo.Test.Base.UiCustomization;
using Kad.PMSDemo.Test.Base.Url;
using Kad.PMSDemo.Test.Base.Web;
...
namespace Kad.PMSDemo.Test.Base
{
    ...
    public class PMSDemoTestBaseModule : AbpModule
    {
        public PMSDemoTestBaseModule(PMSDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.EntityHistory.Selectors.Add("PMSDemoEntities", typeof(User), typeof(Tenant));
        }
